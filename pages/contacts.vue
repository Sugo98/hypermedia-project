<template>
  <main>
    ...
    <!-- Form to toggle between the About us pages-->
    <section class = form>
...
<script>
export default {
  // Function to set up state and data of the page
  setup() {
    const router = useRouter()
    // Retrieve the query parameters from the current route
